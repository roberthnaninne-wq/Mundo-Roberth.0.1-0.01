...
-- 1. Create a helper function to check if the user is the administrator (in public schema)
...
COMMENT ON FUNCTION public.is_admin IS 'Returns true if the authenticated user matches the administrative email.';
